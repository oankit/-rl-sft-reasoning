#!/usr/bin/env python3
"""
Enhanced Layer Importance Visualization Module
============================================

This module provides advanced visualization capabilities for layer importance analysis
in transformer models, specifically designed for mechanistic interpretability research.

Features:
- Best-fit regression lines with confidence intervals
- Professional publication-quality plots
- Support for multiple models and metrics
...
Paper: Layer Criticality in Mathematical Reasoning via Activation Patching
"""
...
# Set professional styling for publication-quality figures
...
def create_enhanced_layer_importance_plot(results_list: List[Dict[str, Any]], 
    ...
    for metric_idx, metric in enumerate(metrics):
        ...
        for model_idx, results in enumerate(successful_results):
            ...
            if has_error_bars and metric == 'FOC':  # FOC typically has confidence intervals
        ...
        if len(successful_results) <= 3:
            # Detailed legend for few models
        ...
        if show_stats and model_stats:
            stats_text = []
            for i, stats in enumerate(model_stats[:3]):  # Show top 3 to avoid clutter
    ...
    # Add overall title if multiple metrics
    if n_metrics > 1:
...
def main_visualization_demo():
    ...
    """
    print("🎨 Enhanced Layer Importance Visualization Demo")
    print("=" * 50)
    ...
    print("✓ Statistical summary saved to layer_importance_statistical_summary.csv")
